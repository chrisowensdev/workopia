...
<section class="flex justify-center items-center mt-20">
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-600 mx-6">
        ...
        <form method="POST" action="/listings">
            ...
            <div class="mb-4">
                <textarea name="description" placeholder="Job Description" class="w-full px-4 py-2 border rounded focus:outline-none"><?= $listing->description ?? ''; ?>
                </textarea>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <input type="text" name="tages" placeholder="Tags" class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $listing->tags ?? ''; ?>" />
            </div>
            <h2 class="text-2xl font-bold mb-6 text-center text-gray-500">
